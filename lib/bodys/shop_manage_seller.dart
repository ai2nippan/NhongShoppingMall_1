...
class _ShopManageSellerState extends State<ShopManageSeller> {
  ...
  Future<Null> refreshUserModel()async{
    ...
    String apiGetUserWhereId = '${MyConstant.domain}/Mobile/Flutter2/Train/testapporder1/php/nhongshoppingmall_1/getUserWhereId.php?isAdd=true&id=${userModel!.id}}';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        floatingActionButton: FloatingActionButton(backgroundColor: MyConstant.primary,
          ...
          onPressed: () =>
              Navigator.pushNamed(context, MyConstant.routeEditProfileSaler).then((value) => refreshUserModel()),
        ),
        body: LayoutBuilder(
