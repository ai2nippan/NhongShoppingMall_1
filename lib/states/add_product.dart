    ...
    if (formKey.currentState!.validate()) {
      ...
      if (checkFile) {
        ...
        String apiSaveProduct =
            '${MyConstant.domain}/Mobile/Flutter2/Train/testapporder1/php/nhongshoppingmall_1/saveProduct.php';
          ...
          await Dio()
              ...
              .then((value) async {
                ...
                if (loop >= files.length) {
                  ...
                  String path = '${MyConstant.domain}/Mobile/Flutter2/Train/testapporder1/php/nhongshoppingmall_1/InsertProduct.php?isAdd=true&idSeller=$idSeller&nameSeller=$nameSeller&name=$name&price=$price&detail=$detail&images=$images';
          ...
          child: Row(
            ...
            children: [
              Container(
                ...
                child: InkWell(
                  onTap: () =>
                      chooseSourceImageDialog(0), //print('You Click Image 1'),
                  child: files[0] == null
              ...
              Container(
                ...
                child: InkWell(
                  onTap: () =>
                      chooseSourceImageDialog(1), //print('You Click Image 2'),
                  child: files[1] == null
                      ? Image.asset(MyConstant.image5)
                      : Image.file(
                          files[1]!,
              ...
              Container(
                ...
                child: InkWell(
                  onTap: () =>
                      chooseSourceImageDialog(2), //print('You Click Image 3'),
                  child: files[2] == null
                      ? Image.asset(MyConstant.image5)
                      : Image.file(
                          files[2]!,
              ...
              Container(
                ...
                child: InkWell(
                  onTap: () =>
                      chooseSourceImageDialog(3), //print('You Click Image 4'),
                  child: files[3] == null
                      ? Image.asset(MyConstant.image5)
                      : Image.file(
                          files[3]!,
