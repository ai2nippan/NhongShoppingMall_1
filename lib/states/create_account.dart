...
class _CreateAccountState extends State<CreateAccount> {
  ...
  Future<Null> findLatLng() async {
    ...
    setState(() {
      // For Show lat, lng =null (Progress Indicator will be work)
        ...
        child: lat == null
            ...
            : GoogleMap(
                initialCameraPosition: CameraPosition(
                  ...
                  zoom: 16, // From space look at earth (zoom value 16)
                ),
  ...
  Future<Null> chooseImage(ImageSource source) async {
    try {
      // deprecated function getImage => pickImage
      //var result = await ImagePicker().getImage(source: source)
