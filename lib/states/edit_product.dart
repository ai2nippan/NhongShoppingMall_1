...
class _EditProductState extends State<EditProduct> {
        ...
        children: [
          ...
          Container(
            ...
            child: files[index] == null
                ? CachedNetworkImage(
                    imageUrl:
                        '${MyConstant.domain}/Mobile/Flutter2/Train/testapporder1/php/nhongshoppingmall_1/${pathImages[index]}',
  ...
  Future<Null> processEdit() async {
    if (formKey.currentState!.validate()) {
      ...
      if (statusImage) {
        ...
        for (var item in files) {
          if (item != null) {
            ...
            String apiUploadImage = '${MyConstant.domain}/Mobile/Flutter2/Train/testapporder1/php/nhongshoppingmall_1/saveProduct.php';

            Map<String, dynamic> map = {};
            // map['file'] = await MultipartFile.fromFile(files[index]);
            map['file'] =
      ...
      String apiEditProduct = '${MyConstant.domain}/Mobile/Flutter2/Train/testapporder1/php/nhongshoppingmall_1/editProductWhereId.php?isAdd=true&id=$id&name=$name&price=$price&detail=$detail&images=$images';
