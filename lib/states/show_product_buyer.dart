...
class _ShowProductBuyerState extends State<ShowProductBuyer> {
  ...
  Future<void> readAPI() async {
    String urlAPI =
        '${MyConstant.domain}/Mobile/Flutter2/Train/testapporder1/php/nhongshoppingmall_1/getProductWhereidSeller.php?isAdd=true&idSeller=${userModel!.id}';
                ...
                content: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      CachedNetworkImage(
                        imageUrl:
                            '${MyConstant.domain}/Mobile/Flutter2/Train/testapporder1/php/nhongshoppingmall_1${images[indexImage]}',
                        placeholder: (context, url) => ShowProgress(),
                      ),
                      Padding(
